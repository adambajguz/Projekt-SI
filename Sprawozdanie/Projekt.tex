...
\begin{itemize}
	...
	\item splitter: strategia używana do wyboru podziału w każdym węźle. Obsługiwane strategie są "best", aby wybrać najlepszy podział i "random", aby wybrać najlepszy podział losowy.
	...
	\item max\_features: liczba funkcji do rozważenia przy poszukiwaniu najlepszego podziału:
	\begin{itemize}
